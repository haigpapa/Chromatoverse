...
| Color | Concept | Examples |
|---|---|---|
| 🩵 Cyan | UI Components | Views, layouts, forms |
| 💗 Magenta | API Calls | Routes, endpoints, requests |
| 💛 Yellow | Auth Logic | JWT, sessions, guards |
| 💚 Green | External Deps | Packages, imports |
| 💙 Blue | State Management | Redux, Context, stores |
